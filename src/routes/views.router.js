...
// // //         res.status(500).json({ error: 'Error eliminando usuario' }); // 500 Internal Server Error
// // //     }
// // // });
...
// // // //         res.status(500).send('Error fetching carts'); // 500 Internal Server Error
// // // //     }
// // // // });
...
// // // //     }
// // // //     res.render('carts', { carts: cart.products });
// // // // });
...
// // //     } catch (error) {
// // //         res.status(500).json({ error: 'Error al obtener productos' }); // 500 Internal Server Error
// // //     }
// // // });
...
// // const router = express.Router(); // Crear una instancia del router
// // const productManagerx = new productManagerx(); // Inicializar el ProductManager
...
// //         const productos = await productManagerx.getProducts({
// //             page: parseInt(page),
// //             limit: parseInt(limit),
// //             query,
// //             sort: validSort,
